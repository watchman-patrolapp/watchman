  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (userLogs.length > 0) {
        ...
        // Fetch route statistics for GPS tracking
        const { data: routeStats } = await supabase
          .from('patrol_routes')
          .select('total_distance_km, total_duration_seconds, start_location, end_location, route_geojson')
          .eq('user_id', user?.id)
          .order('created_at', { ascending: false })
          .limit(1);

        const routeData = routeStats?.[0] || null;
        ...
        setUserStats({
          ...
          routeStats: routeData ? {
            ...
            totalDuration: routeData.total_duration_seconds || 0,
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="text-center">
          <FaTrophy className="w-12 h-12 text-yellow-500 animate-pulse mx-auto mb-3" />
