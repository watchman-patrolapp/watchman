...
import { isLightMobilityVehicleType, getVehicleTypePublicLabel } from './vehicleTypeConstants';
...
export function getVehicleDisplayText(
  ...
  if (isLightMobilityVehicleType(type)) {
    return getVehicleTypePublicLabel(type);
  }
