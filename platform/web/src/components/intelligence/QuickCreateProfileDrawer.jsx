...
export default function QuickCreateProfileDrawer({
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Portaled form still bubbles through the React tree; parent pages (e.g. incident report)
    // wrap content in <form onSubmit> — stop propagation so we don't submit that outer form.
    e.stopPropagation();
    if (!user?.id) {
