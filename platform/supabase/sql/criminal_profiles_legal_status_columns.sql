-- Run in Supabase → SQL Editor if conviction_history_summary / criminal_justice_status are missing.
-- (Same as migration 20260329250000_criminal_profiles_legal_status.sql)
