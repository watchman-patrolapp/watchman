-- Run in Supabase → SQL Editor if `common_presence` / `residence_last_known` are missing.
-- (Same as migration 20260329270000_criminal_profiles_location_presence_residence.sql)
